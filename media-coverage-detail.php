		...
		<section class="news-grid">
			<div class="row">
				<div class="col-md-7 col-md-offset-1">
					<div class="cat-name"><!-- MEDIA COVERAGE -->媒体覆盖率</div>
					<h2 class="news-title">FUN AND LAUGHTER TAKES CENTRE STAGE AS COCA RESTAURANT
GROUP POPS A CORK TO CELEBRATE ITS 60 YEAR ANNIVERSARY</h2>
					<div class="post-meta"><img src="images/common/icon-clock.svg"> December 19, 2017</div>
				</div>
			</div>
			<div class="row">
				<div class="col-md-7 col-md-offset-1">
					...
					<div class="readmore more-btn" style="margin-bottom: 30px; text-align: center;">
						<a style="float: none;" href="media-coverage.php">BACK</a>
					</div>
				</div>
				<div class="col-md-3">
					<div class="row">
						<div class="col-md-11 col-md-offset-1">
							<section class="news-sidebar">
								...
								<?php for($i=0;$i<3;$i++){ ?>
								<a class="news-link" href="media-coverage-detail.php">
